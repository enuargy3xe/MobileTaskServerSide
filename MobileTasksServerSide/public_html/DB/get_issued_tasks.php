...
if(isset($_GET['user_id'])){
    ...
    $request = mysql_query("SELECT Tasks.task_id,Tasks.task_tittle,Tasks.task_details,Tasks.status,Users.user_id,Users.name,Users.surname,Users.user_image FROM Tasks INNER JOIN Users ON Users.user_id = Tasks.to_user AND Tasks.from_user = '$userID'");
